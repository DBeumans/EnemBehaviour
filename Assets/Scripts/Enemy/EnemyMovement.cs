...
public class EnemyMovement : MonoBehaviour {
	...
	[SerializeField]private List<GameObject> myTargets = new List<GameObject>();
	...
	public void setTarget(Vector3 target) {
		myTargets[0].transform.position = target;
	}
	...
	void Seek () {
		...
		Vector3 desiredStep = myTargets[0].transform.position - currentPosition;
